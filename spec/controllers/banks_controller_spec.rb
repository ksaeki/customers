...
describe BanksController do
  ...
  let(:valid_attributes) { { "bankname" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bank as @bank" do
        ...
        post :create, {:bank => { "bankname" => "invalid value" }}, valid_session
        assigns(:bank).should be_a_new(Bank)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bank" do
        ...
        Bank.any_instance.should_receive(:update).with({ "bankname" => "MyString" })
        put :update, {:id => bank.to_param, :bank => { "bankname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bank as @bank" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bank.any_instance.stub(:save).and_return(false)
        put :update, {:id => bank.to_param, :bank => { "bankname" => "invalid value" }}, valid_session
        assigns(:bank).should eq(bank)
      end
